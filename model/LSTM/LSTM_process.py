...
class LSTM_Model(ShowAndSave):
    ...
    def __init__(self, job_name='LSTM', fc='wfzc', fj='A2', model_kind='cap_temp_1',params_kind=None, time_step=5, rnn_units=32,
                 batch_size=60, input_size=9, output_size=1, lr=0.0001,
                 train_steps=15000,datakind='train'):
        super().__init__()
        self.cur_path = cur_path
        self.job_name = job_name + '_' + fc + '_' + fj + '_' + str(time_step) + '_' + str(batch_size)
        ...
        self.model_file_name = self.fj_model_kind + '_lstm.model'
