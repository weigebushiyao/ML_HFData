...
class FeatureSelector():
    ...
    def plot_missing(self):
        ...
        plt.savefig(self.figure_path+'missing_value')
    ...
    def plot_unique(self):
        ...
        plt.savefig(self.figure_path+'single_unique_value')
    ...
    def plot_collinear(self, plot_all=False):
        ...
        plt.savefig(self.figure_path+'feature_correlation')
    ...
    def plot_feature_importances(self, plot_n=15, threshold=None):
        ...
        plt.savefig(self.figure_path+'feature_importance')
...
# # x,y=load_data('test.csv',0.6)
# df=pd.read_csv('../data/trainTestData/wfzc_UP1.5_201908A2.csv')
# df=df.dropna()
# x=df.iloc[:,2:19]
# y=df.iloc[:,20]
...
# fs.identify_zero_importance('regression',early_stopping=False)